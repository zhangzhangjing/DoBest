<template>
	<section>
		...
		<el-tabs v-model="selectedTab" style="padding:20px;">
			<el-tab-pane label="广告设置" name="first">
				<el-form :model="addForm" label-width="160px" label-position="left">
					<el-form-item label="广告主题">
						<el-input v-model="addForm.description" :maxlength="12"></el-input>
					</el-form-item>
			...
			<el-tab-pane label="已报名的客户" name="second">
				<el-table :data="list" v-loading="listLoading" style="width: 100%;" key="orders">
					...
					<el-table-column prop="mobilephone" label="联系方式" width="140"> </el-table-column>
	...
	export default {
		...
		methods: {
			...
			customersFetch:function(){
				...
				api.ibs.joinedCustomersFetch(this.page).then((response) => {
