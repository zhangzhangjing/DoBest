...
<!--                 <el-form-item>
                ...
                <!-- EntityType.Producer.value 授权生产商 -->
                ...
                <el-form-item>
                 ...
                 <el-form-item>
                    <el-button type="primary" @click="orderSet">订单分配</el-button>
                </el-form-item>
            </el-form>
        </el-col>
        <!--列表-->
        <el-table :data="list" v-loading="listLoading" style="width: 100%;">
            ...
            <!-- 后端 -->
            <el-table-column  label="生产能力" width="140"> 
                <!-- v-model="visibleText" -->
                    <el-popover ref="popoverEnable" placement="top" width="160" >
                        <p>有效期设置</p>
                    </el-popover>
                    <!-- 新增“生产能力”展示企业能生产的产品信息 -->
                    <el-button type="primary"  v-popover:popoverEnable @click="lookEnable">查看</el-button>
            </el-table-column>
                ...
                <template scope="scope">
                  ...
                  <!--   <template v-if="status !== '' && status == ReviewStatus.Reviewing.value">
                    ...
                    <!-- <template v-if="entityType == EntityType.Agency.value">
                        <el-button size="small" @click="showTrafficsource(scope.row)">活动参与单位</el-button>
                    </template> -->
        ...
        <el-dialog :title="addForm.dialogTitle" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="120px" :rules="addFormRules" ref="addForm">
                ...
                <!--后端 由机器改为“产品” -->
                <el-form-item  v-if="entityType == EntityType.Agency.value">
        ...
        <!--  分配面板 -->
        <el-dialog title="订单归属分配" size="large" :visible.sync="distributionFormVisible" :close-on-click-modal="false">
            <!-- <el-form :model="addForm" label-width="120px" :rules="addFormRules" ref="addForm">
            </el-form> -->
            <el-row>
                <el-col :span="8">
  ...
  export default {
    ...
    methods: {
        ...
        orderSet() {
            ...
            // if(agencyID){
            //     this.$router.push({ name: 'OrderRule', query: { agency:agencyID}});
            // }
            this.$router.push({ name: 'OrderRule'})
        },
        // 查看生产能力后端
        lookEnable () {
            console.log('llala')
