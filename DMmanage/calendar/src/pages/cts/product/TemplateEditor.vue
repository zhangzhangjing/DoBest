	...
	<section>
		...
		<el-row>
			<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
				<el-form :inline="true">
					<el-form-item>
						<el-button @click="settingBtnTapped">统一坐标设置</el-button>
					</el-form-item>
					<el-form-item>
						<el-button>插入广告模板</el-button>
					...
					<el-form-item>
						<el-button @click="addBtnTapped">添加用户模板</el-button>
					</el-form-item>
				</el-form>
			</el-col>
...
<el-col :span="24" class="main">
	<div class="container">
		...
		<el-dialog :title="changeTitle" :visible.sync="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="120px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="图片">
					<el-input v-model="settingFormImage.pointleft" placeholder="pointleft" style="width:20%;"></el-input>
					<el-input v-model="settingFormImage.pointtop" placeholder="pointtop" style="width:20%;"></el-input>
					<el-input v-model="settingFormImage.pointwidth" placeholder="pointwidth" style="width:20%;"></el-input>
					<el-input v-model="settingFormImage.pointhight" placeholder="pointhight" style="width:20%;"></el-input>
				</el-form-item>
				<!-- 打印模板和缩略图DIY展示模板 -->
		...
		<!--新增界面-->
		<el-dialog title="坐标设置" :visible.sync="settingFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="120px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="打印号">
					<el-input v-model="settingFormTag.pointleft" placeholder="pointleft" style="width:20%;"></el-input>
					<el-input v-model="settingFormTag.pointtop"  placeholder="pointtop" style="width:20%;"></el-input>
					<el-input v-model="settingFormTag.pointwidth" placeholder="pointwidth" style="width:20%;"></el-input>
					<el-input v-model="settingFormTag.pointhight" placeholder="pointhight" style="width:20%;"></el-input>
				</el-form-item>

			<!-- 	<el-form-item label="封面">
					<el-input v-model="settingFormFront.pointleft" placeholder="pointleft" style="width:20%;"></el-input>
					<el-input v-model="settingFormFront.pointtop" placeholder="pointtop" style="width:20%;"></el-input>
					<el-input v-model="settingFormFront.pointwidth" placeholder="pointwidth" style="width:20%;"></el-input>
					<el-input v-model="settingFormFront.pointhight" placeholder="pointhight" style="width:20%;"></el-input>
				</el-form-item> -->

			</el-form>
			<div slot="footer" class="dialog-footer">
				<el-button @click.native="settingFormVisible = false">取消</el-button>
				<el-button type="primary" @click.native="settingSubmitBtnTapped" :loading="addLoading">确定</el-button>
			</div>
		</el-dialog>
	...
	export default {
		data() {
			return {
				...
				uploadForm:{},
				uploading:false,
				uploaders:[{name:'compress', label:"预览图", uploading:false, imageURL:'', previewImageURL:'', uploadForm:{},
	                      ...
	                      {name:'origin', label:"大图", uploading:false, imageURL:'', previewImageURL:'', uploadForm:{},
								  beforeUpload:file =>{return this.beforeUpload("origin", file)},
								  uploadFail:(error,file)=>{this.uploadFail("origin", error, file);},
								  uploadSuccess:(response,file)=>{this.uploadSuccess("origin", response, file);}}
	            ]
		...
		methods: {
			...
			settingBtnTapped(){
				//var image = { "pointleft":0, "pointtop":0, "pointhight":0, "pointwidth":0};
				//var tag = Object.assign({}, image);
				//var front = Object.assign({}, image);
				//this.settingFormImage = image;
				//this.settingFormTag = tag;
				//this.settingFormFront = front;
			...
			modifyStyleTemplatePhoto(){
				var form = Object.assign({}, this.addForm);
				form.isround = form.isround ? 1 : 0;
				var parmas = { "id": form.id, "layerimg":form.layerimg,"layerimgpreview":form.layerimgpreview,
