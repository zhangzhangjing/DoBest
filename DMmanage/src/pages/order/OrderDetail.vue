	        	...
	        	<template v-for="item in products">
	                <div class="product-cell">
	                    <div class="product-cell-middle">
	                    	...
	                    	<span class="base-info-text">类型:  {{item.propertystr}}</span>
	...
	export default {
		...
		methods: {
			...
			orderDetailFetch: function (id) {
				...
				this.loading = true;
				NProgress.start();
				yiya.orderDetailFetch(id).then(response =>{
		            ...
		            this.statusString = yiya.orderStatusDescFecth(status);
			...
			shippingInfoFetch:function(carrier, shippingNo){
				yiya.shippingInfoFetch(carrier, shippingNo).then(response =>{
